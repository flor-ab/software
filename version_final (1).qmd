...
## Parte 3: [**<Evolución del Porcentaje de Voto en Relación al Censo por Comunidad Autónoma>**] {hl.green}
...
## Parte 3: [**<¿Es cierto que determinados partidos ganan en las zonas rurales?>**] {hl.green}
...
- **Participación Electoral**: En torno a **2015**, la participación disminuyó, pero se _**recuperó hacia 2017-2018**_.  

- **Diferencias Regionales**: Algunas comunidades se mantienen cerca del **80%**, mientras que otras caen al **50%** en ciertos años.  

- **Cambio Político**: Desde **2008**, el _**bipartidismo**_ ha dado paso a **nuevos partidos** como _**Podemos**_ y _**Vox**_, complicando las mayorías absolutas y forzando **coaliciones**.  

- **Municipios Grandes**: Los _**partidos tradicionales**_ siguen liderando, pero desde **2015**, los _**nuevos partidos**_ ganan apoyo.  
